    ...
    <nav class="nav-teacher1" id="nav-teacher1">
        ...
        <div class="nav-teacher3">
            ...
            <div class="nav-teacher3-v3">
                <a href="#"><i class="fa fa-pencil-square" aria-hidden="true"></i> Kinh nghiệm giảng dạy</a>
            </div>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-7" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-custom" href="#">Đổi mật khẩu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link nav-custom" data-toggle="modal" href="#modal-logout">Đăng xuất</a>
                            </li>
                        </ul>
                    </div>
                </li>
