                                ...
                                <div class="nav-modal3-v4">
                                    <li class="nav-item">
                                        <a class="nav-link nav-bar" href="#" data-toggle="collapse"
                                            ...
                                            aria-controls="submenu-2">Thông tin gia sư <i class="fa fa-caret-down"
                                                aria-hidden="true" style="float: right;"></i></a>
                                        <div id="submenu-2" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link nav-bar" href="#">Cập nhật thông tin</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link nav-bar" href="#">Đổi mật khẩu</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link nav-bar" data-toggle="modal"
                                                        href="#modal-logout">Đăng xuất</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
